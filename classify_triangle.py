...
class ClassifyTriangle:
    def __init__(self, side1: int, side2: int, side3: int):
        ...
        self.s2 = side2
        self.s3 = side3
        self.validate_sides() #Thank you ChatGPT for this contribution!
    ...
    def validate_sides(self): 
        ...
        if self.s1 + self.s2 <= self.s3 or self.s1 + self.s3 <= self.s2 or self.s2 + self.s3 <= self.s1: # Triangle Inequality Theorem suggested by ChatGPT
    ...
    def right_triangle(self) -> bool:
        ...
        return round(sides[0]**2 + sides[1]**2, 2) == round(sides[2]**2, 2) #Thank you ChatGPT for this contribution!
